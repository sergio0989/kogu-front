(function(){
  const NAV=[
    ...
    {section:'Radar Comercial',items:[
      ...
      {href:'/modules/rc/nuevas-ventas.html',label:'Ventas nuevas',perm:'screen.ventas.direccion'},
    ...
    {section:'Costo',items:[
      ...
      {href:'/modules/cto/segmentos-catalogo.html',label:'⚙️ Catálogo de segmentos',perm:'screen.cto.segmentos'},
