  ...
  <div class="table-wrap" style="margin-top:14px">
    <table>
      <thead><tr id="thead">
        ...
        <th data-sort="revisado" style="text-align:center;cursor:pointer;width:38px;white-space:nowrap;padding-left:2px;padding-right:2px">Rev.</th>
        <th data-sort="muestra" style="text-align:center;cursor:pointer;width:42px;white-space:nowrap;padding-left:2px;padding-right:2px" title="Muestra facturada (precio no representativo, costo real). Se excluye de rentabilidad.">Mtra.</th>
        <th style="text-align:center;white-space:nowrap;width:82px;padding-left:6px;padding-right:6px">Acción</th>
      </tr></thead>
  ...
  function render(rows) {
    ...
    tb.innerHTML = rows.map(r => {
      ...
      <tr style="${r.costo_manual ? 'background:#fef9c3' : (r.es_muestra ? 'background:#eef2ff' : '')}">
        ...
        <td style="text-align:center;width:42px;padding-left:2px;padding-right:2px" title="Muestra facturada (se excluye de rentabilidad)">
          <input type="checkbox" data-mtra="${r.venta_id}" ${r.es_muestra ? 'checked' : ''} style="width:14px;height:14px;cursor:pointer"/>
        </td>
        <td style="text-align:center;white-space:nowrap;width:82px;padding-left:6px;padding-right:6px">
