  ...
  function abrirModalImport() {
    ...
    oQ('#uploadBtn').addEventListener('click', async () => {
      ...
      try {
        ...
        const hayAdvertencias = (data?.sin_producto?.length ?? 0) > 0;
        ...
        oQ('#importResult').innerHTML = `
          ...
          ${hayAdvertencias ? `<br><span style="font-size:12px">Los lotes con cve_prod sin match importarán sin producto — vincúlalos desde el catálogo de Productos.</span>` : ''}
        `;
